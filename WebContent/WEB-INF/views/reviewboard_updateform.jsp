	...
	<section class="single-post-area">
		<div class="container">
			...
			<div class="comment-form">
				...
				<form action="reviewboard_update" method="post"
					...
					<div class="inputArea">
						 <label for="RuploadFile"  style="font-size : 1.2em ; color : black; float:left"></label> 
						<input multiple="multiple"
							type="file" id="RuploadFile" name="RuploadFile"
					...
					<input type="submit" id="submit" class="primary-btn text-uppercase"
						...
						onclick="location.href='reviewboard_detail?reviewboardno=' +${dto.reviewboardno}  +'&page=' + ${scri.page} +'&perPageNum=' +${scri.perPageNum}">
				</form>
			</div>
		</div>
	</section>
