									...
									<div class="breakfast">
										<div class="col-lg-4" style="float: left;z-index: 1; width: 33%;">
											...
											<div class="single-service">
												...
												<div class="thumb" onclick="location.href='rboard_detail?boardno='+${dto.boardno} +'&page=' + ${scri.page} +'&perPageNum=' +${scri.perPageNum}
												">
		...
		<ul class="pagination">
			<c:if test="${pageMaker.prev}">
				<li class="page-item"><a class="page-link"
					aria-label="Previous"
					href="listSearchsendmail${pageMaker.makeQuery(pageMaker.startPage - 1)}
			...
			<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}"
				var="idx">
				<li class="page-item"><a class="page-link"
					href="listSearchsendmail${pageMaker.makeQuery(idx)}
					&foodkind=${scri.foodList[0]} 
					&countrykind=${scri.countryList[0]}
					&timekind=${scri.timeList[0]}
					&SearchType=${scri.searchType}
			...
			<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
				<li class="page-item"><a class="page-link" aria-label="Next"
					href="listSearchsendmail${pageMaker.makeQuery(pageMaker.endPage + 1)}
					&foodkind=${scri.foodList[0]} 
					&countrykind=${scri.countryList[0]}
					&timekind=${scri.timeList[0]}
					&SearchType=${scri.searchType}
