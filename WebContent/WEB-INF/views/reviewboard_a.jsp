		...
		<div class="container">
			...
			<div class="search_area">
				<form action="listSearchsendmail123" method="get" id="searchForm">
					...
					<div style="font-size: 20px ; color:red" >* 검색 조건</div>
					<br><br>
						<div class="search_div1">
							<ul style="float:left; ">
								<li class="search_li"  style="float:left;font-size: 20px ">음식종류별 : &nbsp;&nbsp; </li>
							
								<li class="check_li"  style="float:left; "><input type="checkbox" id="s1"
									name="foodkind" value="밥류" style="width:20px; height:20px; font-size: 20px" /><label for="s1" style="font-size: 20px; ">밥류 &nbsp;&nbsp;     </label></li>
								<li class="check_li"  style="float:left; "><input type="checkbox" id="s2"
									name="foodkind" value="빵류" style="width:20px; height:20px; font-size: 20px" /><label for="s2" style="font-size: 20px">빵류  &nbsp;&nbsp; </label></li>
								<li class="check_li"  style="float:left; "><input type="checkbox" id="s3"
									name="foodkind" value="면류" style="width:20px; height:20px;font-size: 20px "/><label for="s3" style="font-size: 20px">면류 &nbsp;&nbsp; </label></li>
							
								<li class="check_li"  style="float:left; "><input type="checkbox" id="s4"
									name="foodkind" value="밑반찬류" style="width:20px; height:20px;font-size: 20px" /><label for="s4" style="font-size: 20px">밑반찬류 &nbsp;&nbsp; </label></li>
								<li class="check_li"  style="float:left; "><input type="checkbox" id="s5"
									name="foodkind" value="디저트/음료" style="width:20px; height:20px;font-size: 20px" /><label for="s5" style="font-size: 20px">디저트/음료 &nbsp;&nbsp; </label></li>
								<li class="check_li"  style="float:left; "><input type="checkbox" id="s6"
									name="foodkind" value="기타"  style="width:20px; height:20px;font-size: 20px"/><label for="s6" style="font-size: 20px">기타 &nbsp;&nbsp; </label></li>
							</ul>
						</div>
						<br>
						<br>
						...
						<div class="search_div2">
							<ul  style="float:left; ">
								<li class="search_li"  style="float:left; font-size: 20px">나라별 :  &nbsp;&nbsp;</li>
								
								<li style="float:left;"><input type="checkbox" id="r1" name="countrykind"
									value="한식"  style="width:20px; height:20px;  font-size: 20px"/> <label for="r1" style="font-size: 20px">한식  &nbsp;&nbsp;</label></li>
								<li style="float:left;"><input type="checkbox" id="r2" name="countrykind"
									value="중식"  style="width:20px; height:20px; font-size: 20px"/> <label for="r2" style="font-size: 20px">중식  &nbsp;&nbsp;</label></li>
								<li style="float:left;"><input type="checkbox" id="r3" name="countrykind"
									value="일식" style="width:20px; height:20px; font-size: 20px" /> <label for="r3" style="font-size: 20px">일식  &nbsp;&nbsp;</label></li>
								<li style="float:left;"><input type="checkbox" id="r4" name="countrykind"
									value="양식" style="width:20px; height:20px ; font-size: 20px" /> <label for="r4 " style="font-size: 20px">양식  &nbsp;&nbsp;</label></li>
								<li style="float:left;"><input type="checkbox" id="r5" name="countrykind"
									value="기타" style="width:20px; height:20px ; font-size: 20px"  /> <label for="r5 " style="font-size: 20px">기타  &nbsp;&nbsp;</label></li>
						...
						<div class="search_div3 ">
							<ul  style="float:left; ">
							     <li class="search_li"  style="float:left;font-size: 20px ">조리시간별 : &nbsp;&nbsp;</li>
								<li style="float:left;"><input type="checkbox" id="t1" name="timekind"
									value="초간단 요리" style="width:20px; height:20px; font-size: 20px" /> <label for="t1" style="font-size: 20px">초간단 요리  &nbsp;&nbsp;</label></li>
								<li style="float:left;"><input type="checkbox" id="t2" name="timekind"
									value="5분이내"  style="width:20px; height:20px; font-size: 20px" /> <label for="t2" style="font-size: 20px">5분이내  &nbsp;&nbsp;</label></li>
								<li style="float:left;"><input type="checkbox" id="r3" name="timekind"
									value="15분이내"  style="width:20px; height:20px; font-size: 20px" /> <label for="t3" style="font-size: 20px">15분이내  &nbsp;&nbsp;</label></li>
								<li style="float:left;"><input type="checkbox" id="t4" name="timekind"
									value="30분이내"  style="width:20px; height:20px; font-size: 20px" /> <label for="t4" style="font-size: 20px">30분이내  &nbsp;&nbsp;</label></li>
								<li style="float:left;"><input type="checkbox" id="t5" name="timekind"
									value="장시간 요리" style="width:20px; height:20px; font-size: 20px" /> <label for="t5" style="font-size: 20px">장시간 요리  &nbsp;&nbsp;</label></li>
				...
				$(function() {
					$("#muldelform").submit(function() {
						...
						for(var i =0; i<$("#muldelform input:checked").length; i++) {
							...
							alert(  $("#muldelform input:checked").eq(i).val()  ); //게시글 번호 하나씩 뜸.
								...
								<c:forEach items="${searchList }" var="dto">
									...
									<div class="breakfast">
										<div class="col-lg-4" style="float: left;z-index: 1; width: 33%;">
											<input type="checkbox" name="chk" value="${dto.reviewboardno }" style="width:20px; height:20px;">
											
											&nbsp;&nbsp;&nbsp;  <a href="rboard_detail?boardno=${dto.rboardno}">원본 레시피 보러가기</a>
											<div class="single-service">
										
											
												<div class="thumb" onclick="location.href='reviewboard_detail?reviewboardno='+${dto.reviewboardno} +'&page=' + ${scri.page} +'&perPageNum=' +${scri.perPageNum}">

													<img src="${pageContext.request.contextPath}${dto.gdsThumbImg }"
													style="width: 350px; height: 210px ; z-index: 1;" />

												</div>
												
													<h4 style="display: inline-block; z-index: 1;" 
													onclick="location.href='reviewboard_detail?reviewboardno='+${dto.reviewboardno} 
													+'&page=' + ${scri.page} +'&perPageNum=' +${scri.perPageNum}">${dto.title}</h4>
		...
		<ul class="pagination">
			<c:if test="${pageMaker.prev}">
				<li class="page-item"><a class="page-link"
					aria-label="Previous"
					href="reviewboard_a${pageMaker.makeQuery(pageMaker.startPage - 1)}
					&foodkind=${scri.foodList[0]} 
					&countrykind=${scri.countryList[0]}
					&timekind=${scri.timeList[0]}
			...
			<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}"
				var="idx">
				<li class="page-item"><a class="page-link"
					href="reviewboard_a${pageMaker.makeQuery(idx)}
					&foodkind=${scri.foodList[0]} 
					&countrykind=${scri.countryList[0]}
					&timekind=${scri.timeList[0]}
					&SearchType=${scri.searchType}
			...
			<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
				<li class="page-item"><a class="page-link" aria-label="Next"
					href="reviewboard_a${pageMaker.makeQuery(pageMaker.endPage + 1)}
					&foodkind=${scri.foodList[0]} 
					&countrykind=${scri.countryList[0]}
					&timekind=${scri.timeList[0]}
					&SearchType=${scri.searchType}
