...
<body>
	...
	<section class="post-content-area single-post-area">
		<div class="container">
			...
			<script type="text/javascript">
		  $('#content123>img').css({width:1100, height:500 });
		  $('#content123>img').css({"position" : "relative"});
		  $('#content123>img').css({"left": "0px"});
		</script>
	...
	<section class="post-content-area single-post-area">
		...
		<div class="container">
			...
			<div style="float: right">
                ...
                href="reviewboard_updateform?reviewboardno=${dto.reviewboardno}&page= ${scri.page} &perPageNum=${scri.perPageNum}
				...
				<a class="submit primary-btn text-uppercase" 
				href="reviewboard_delete?reviewboardno=${dto.reviewboardno} 
			...
			<form class="box_write" id="comment" name="comment"
				action="reviewcommentwrite" accept-charset="UTF-8" method="post">
					...
					<li class="">
						...
						<c:if test="${dto2.id == dto1.commentwriter }">
						  ...
						  <div  style="display: inline-block; float:right; "   >
						         <a href='reviewboard_comment_delete?commentno=${dto1.commentno }&reviewboardno=${dto1.reviewboardno}'>  삭제    </a></div>
						
						  <div style="display: inline-block; float:right; "> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  </div>
						
						  <div style="display: inline-block; float:right;
						    "  ><a href='reviewboard_detail_commentupdateform?commentno=${dto1.commentno }&reviewboardno=${dto1.reviewboardno}'>  수정   </a></div>
