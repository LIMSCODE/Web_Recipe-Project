	...
	<section class="post-content-area single-post-area">
		...
		<div class="container">
               ...
               //좋아요 ajax전송
				...
				$(function(){
					...
					$("#likeupdate").click(function(){
						alert("hi");
						var reviewboardno = "${dto.reviewboardno}";
						var id = "${dto2.id}";
			...
			<form class="box_write" id="comment" name="comment"
				...
				<input type="hidden" name="reviewboardno" value="${dto1.reviewboardno }">
	...
	<c:forEach items="${commentlist}" var="dto">
			...
			<!-- 수정하기 클릭한 글 : 컨트롤레어서 dto1로 뿌렸음. -->
			   <c:if test="${dto1.commentno == dto.commentno }">
				...
				<form action="reviewboard_comment_update" method="post"
			       ...
			       <ul class="">
					<li class="">
					   ...
					   <input type="hidden" class="form-control" id="commentcontenta"
						...
						onclick="location.href='reviewboard_detail?reviewboardno=${dto1.reviewboardno}'">
