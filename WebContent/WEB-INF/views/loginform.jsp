		...
		<div class="container  ">
			<div class="row justify-content-between align-items-center " style="position:relative;
				...
				<div class="col-lg-5 reservation-right ">
					...
					<form class=" text-center" action="originallogin">
						...
						<input type="submit" class="primary-btn text-uppercase mt-20" style="width: 230px"value="로그인"/>
					    ...
					    <p style=""onClick="location.href='registform'">회원가입</p>
